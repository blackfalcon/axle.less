<?php include 'shared/head.php'?>
	...
	<header class="styleguide_header"><h1>| Axle | '960 grid' | 12 col | fluid</h1></header>
	...
	<article class="styleguide_body">
		...
		<div class="grid_960">
			<ul>
				<li class="flgrid-1">.flgrid_12(1)</li>
				<li class="flgrid-11">.flgrid_12(11)</li>
			</ul>
			<ul>
				<li class="flgrid-2">.flgrid_12(2)</li>
				<li class="flgrid-10">.flgrid_12(10)</li>
			</ul>
			<ul>
				<li class="flgrid-3">.flgrid_12(3)</li>
				<li class="flgrid-9">.flgrid_12(9)</li>
			</ul>
			<ul>
				<li class="flgrid-4">.flgrid_12(4)</li>
				<li class="flgrid-8">.flgrid_12(8)</li>
			</ul>
			<ul>
				<li class="flgrid-5">.flgrid_12(5)</li>
				<li class="flgrid-7">.flgrid_12(7)</li>
			</ul>
			<ul>
				<li class="flgrid-6">.flgrid_12(6)</li>
				<li class="flgrid-6">.flgrid_12(6)</li>
			</ul>
			<ul>
				<li class="flgrid-7">.flgrid_12(7)</li>
		...
		<article>
			...
			<p>Using something like <code>.flpush_12(.5)</code> will push the block element 1/2 a grid (or 40px per this example).</p>
