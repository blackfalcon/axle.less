<?php include 'shared/head.php'?>
	...
	<article class="styleguide_body">
		<div class="instructions">
			...
			<p>Axle's grid.LESS can support both a 12 and 16 col grid system.  Below is an example of a 12 col.  In each grid is the width percentage of the 960px space with it's mixin value.  See code instructions and examples below.	</p>
			<p></p>
		</div>
		<header>
			<p>1. 960 Site grid</p>
		...
		<div class="grid_960">
			<ul>
				<li class="grid-7">56.25% | .grid_12(7)</li>
				<li class="grid-5">39.58% | .grid_12(5)</li>
			</ul>
			<ul>
				<li class="grid-8">64.58% | .grid_12(8)</li>
				<li class="grid-4">31.25% | .grid_12(4)</li>
			</ul>
			<ul>
				<li class="grid-9">72.91% | .grid_12(9)</li>
				<li class="grid-3">22.91% | .grid_12(2)</li>
			</ul>
			<ul>
				<li class="grid-10">81.25% | .grid_12(10)</li>
				<li class="grid-2">14.58% | .grid_12(2)</li>
			</ul>
			<ul>
				<li class="grid-11">89.58% | .grid_12(11)</li>
				<li class="grid-1">6.25%</li>
			</ul>
			<ul>
				<li class="grid-12">97.91% | .grid_12(12)</li>
			</ul>
			<ul>
				<li class="grid-1">6.25%</li>
				<li class="grid-11">89.58% | .grid_12(11)</li>
			...
			<ul>
				<li class="grid-3">22.91% | .grid_12(3)</li>
				<li class="grid-9">72.91% | .grid_12(9)</li>
			</ul>
			<ul>
				<li class="grid-4">31.25% | .grid_12(4)</li>
			...
			<ul>
				<li class="grid-6">47.93% | .grid_12(6)</li>
				<li class="grid-6">47.93% | .grid_12(6)</li>
			</ul>
		</div>
		<article>
