<?php include 'shared/head.php'?>
		...
		<section class="body_call_to_action">
			<ul>
				<li><h3>Wanna see the code? Download the latest version =></h3></li>
		...
		<section class="page_content lower_content">
			<article class="main_article">	
				<h5>The story ...</h5>
				<img src="http://gigapple.files.wordpress.com/2009/12/css_icon.png" alt="CSS Icon" title="CSS Icon Image" />
				<p>Truth be told, Axle was a complete accident.  I had no intentions of creating a CSS framework.  But some of the best breakthroughs are accidents.  To understand Axle, you need to understand Axle's history.</p>
				<p>As a web developer I have always looked for a better way to manage all the UI assets that I was creating.  And over time as  tools like HTML5 and CSS3 continue to change the world we live in, the need to manage these assets continued to grow.</p>
				<p>Thinking <em>elemental</em> or <em>modular</em> about my design work are principals I have followed my whole career.  When working on dynamic websites where most of the experience is user driven, you really do need to think about your designs from a different perspective. The concept of a <em>page</em> becomes irrelevant.  The real win is when you can look at your design and clearly understand what is the element, the widget and how these will build a screen or experience.</p>
